...
// sealGroup = '1+{2,3}:1+6+{4,5}:1+7;1+{2,3}:1+4';
sealGroup = '1+2;{1,2}:1+3;3+{1,2}:1;{1,2}:1+3+{4,5}:1';
sealGroup = '1+2;2+{1,4}:1+3;3+{1,2}:1;{1,2}:1+3+{4,5}:1';
// sealGroup = '1+2;{1,4}:1+3+2;3+{1,2}:1;{1,2}:1+3+{4,5}:1';
console.log(
  reg1.test(sealGroup) ||
    reg2.test(sealGroup) ||
